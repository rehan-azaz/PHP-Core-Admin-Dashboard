    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            <div class="container mt-5">
                <form action="add-category.php" class="form-horizontal" method="post">
                    <div class="card">
                            ...
                            <form action="add-category.php" method="post" class="form-horizontal">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="txt-category-name" name="txt-category-name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" for="category-image">Category Image</label>
                                        <div class="col-sm-6">
                                            <input type="file" accept="image/*" class="form-control" id="category-image" name="category-image" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <textarea rows="5" class="form-control" name="txt-category-description" ></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
