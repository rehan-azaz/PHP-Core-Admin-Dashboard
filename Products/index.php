                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <a href="add-product-form.php">
                            <button class="btn btn-outline-secondary float-right mb-3" id="btn-add-product">Add Product</button>
                        </a>
                        <table id="product-datatable" class="display" cellspacing="0" width="100%">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
